...
class Home extends React.Component {
    constructor(props){
        ...
        this.editFromSearch = this.editFromSearch.bind(this);
    }
    ...
    editFromSearch(e,i){
        let itemToEdit = e.target.value;
        let arrayAfterEdit = [...this.state.searchResults];
        arrayAfterEdit[i] = itemToEdit;
        this.setState({searchResults: arrayAfterEdit});
    }
                    ...
                    (this.state.searchResults.map((item,index)=>{
                            return(
                                <div>
                                    ...
                                    {editClicked ? (<input  value={item} onChange={(e) =>
                                        this.editFromSearch(e,index)}/>) : null}
